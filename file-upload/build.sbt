...
homepage := Some(new URL("https://github.com/yangbajing/scala-applications/tree/master/file-upload"))
...
scalacOptions ++= Seq("-encoding", "utf8", "-unchecked", "-feature", "-deprecation")
...
libraryDependencies ++= Seq(
  ...
  _logback,
  _scalaLogging,
  _scalatest) ++ _akkas ++ _akkaHttps ++ _jsons
...
lazy val _akkaHttps =
  Seq("com.typesafe.akka" %% "akka-http" % "10.1.8", "com.typesafe.akka" %% "akka-http-testkit" % "10.1.8" % Test)
